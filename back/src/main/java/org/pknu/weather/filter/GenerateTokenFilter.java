...
import org.pknu.weather.security.util.KakaoUserInfoStrategy;
...
public class GenerateTokenFilter extends OncePerRequestFilter {
    ...
    private Map<String, String> getAppToken(Map<String, Object> userInfo) {

        Map<String, String> appToken = appTokenGenerator.generateAppToken(userInfo);
        return appToken;
