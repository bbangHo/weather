...
class TagRepositoryTest {
    ...
    void test() {
        ...
        // when
        Tag tagQueryResult = tagRepository.rankingTags(location);
//        Long count = tagQueryResult.getDustCount() + tagQueryResult.getHumidityCount() + tagQueryResult.getSkyCount() +
//                tagQueryResult.getTempCount() + tagQueryResult.getWindCount();
